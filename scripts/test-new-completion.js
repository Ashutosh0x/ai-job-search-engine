// Test new profile completion calculation
const testNewCompletion = () => {
  // Real profile data from audit logs
  const profile = {
    name: "ashutosh", // Fixed name
    title: "",
    company: "",
    bio: "",
    experience: "",
  ...
  console.log('New completion calculation:', completion + '%')
